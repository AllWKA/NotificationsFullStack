...
function createAdmin(event) {
  ...
  if (checkFormCreate()) {
    ...
    var method = "POST", url = "http://192.168.1.125:3000/admin";
    var newAdmin = {
...
function deleteAdmin() {
  var xhttp = new XMLHttpRequest(), method = "DELETE", url = "http://192.168.1.125:3000/admin/" + inputEmail.placeholder;
  xhttp.onreadystatechange = function () {
...
function updateAdmin(event) {
  ...
  if (inputEmail.value == "" || userNameInput.value == "" || inputPassword.value == "") { alert("fill all inputs please!"); }
    ...
    var xhttp = new XMLHttpRequest(), method = "PUT", url = "http://192.168.1.125:3000/admin/" + inputEmail.placeholder;
...
function listAllUsers() {
  var xhttp = new XMLHttpRequest(), method = "GET", url = "http://192.168.1.125:3000/admins";
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
